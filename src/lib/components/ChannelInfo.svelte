...
<div class="flex my-5 items-center justify-between">
	<div class="flex items-center gap-5">
		<div class="flex items-center gap-3">
			<img src="/avatar.png" class="w-10 h-10 rounded-full" alt="" />
			<div>
				<p class="font-medium capitalize">Saurab Yt</p>
				<p class="text-gray-700 text-xs">1000 subs</p>
			</div>
		</div>
		<button
			class="bg-black text-white text-sm w-fit font-medium rounded-full
  py-2 px-4"
		>
			Subscribe</button
		>
		<div class="flex gap-3 items-center">
			...
			<button class="hover:bg-gray-200 rounded-full py-2 px-4 flex items-center gap-2">
				<img src="/icons/shareIcon.svg" alt="" />
				<span class="text-sm font-medium">share</span>
			</button>
			<button class="hover:bg-gray-200 rounded-full flex items-center gap-2">
